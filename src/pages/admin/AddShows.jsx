...
import { VoteConverter } from "../../lib/VoteConverter";
...
const AddShows = () => {
    ...
    return nowPlayingMovies.length > 0 ? (
        <>
                        ...
                        >
                            <div className="relative rounded-lg overflow-hidden">
                                ...
                                <div className="text-sm flex items-center justify-between p-2 bg-black/70 w-full absolute bottom-0 left-0">
                                    ...
                                    <span className="text-gray-300">Votes: {VoteConverter(movie.vote_count)}</span>
            ...
            <button className="bg-primary text-white px-8 py-2 rounded hover:bg-primary/90 transition-all cursor-pointer">
                Add Show
            </button>
