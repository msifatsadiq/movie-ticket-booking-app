...
const MovieDetails = () => {
    ...
    return show ? (
        <div className="px-6 md:px-16 lg:px-40 pt-30 mdLpt-50">
            <div className="flex flex-col md:flex-row gap-8 max-w-6xl mx-auto ">
                ...
                <div className="relative flex flex-col gap-3">
                    ...
                    <div className="flex items-center gap-4 mt-4 flex-wrap">
                        ...
                        <a href="#dateSelect" className="px-10 py-3 text-sm bg-primary hover:bg-green-500 transition 
                ...
                <div className="flex items-center gap-4 w-max px-4">
                    {
                        show.movie.casts.slice(0, 12).map((cast, index) => (
                            <div key={index} className="flex flex-col text-center items-center gap-4">
